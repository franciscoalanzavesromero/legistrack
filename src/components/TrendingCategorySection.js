            ...
            <div className="col-lg-8">
              <div className="row g-5">
                <div className="col-lg-4 border-start custom-border">
                  ...
                  <div className="post-entry">
                    <a href="#"><img src={postLandscape5} alt="" className="img-fluid" /></a>
                    <div className="post-meta"><span className="date">Food</span> <span className="mx-1">•</span> <span>Jul 17th '22</span></div>
                    <h2><a href="#">How to Avoid Distraction and Stay Focused During Video Calls?</a></h2>
                  </div>
                  <div className="post-entry">
                    <a href="#"><img src={postLandscape7} alt="" className="img-fluid" /></a>
                    <div className="post-meta"><span className="date">Design</span> <span className="mx-1">•</span> <span>Mar 15th '22</span></div>
                    <h2><a href="#">Why Craigslist Tampa Is One of The Most Interesting Places On the Web?</a></h2>
                  </div>
                </div>
                <div className="col-lg-4 border-start custom-border">
                  <div className="post-entry">
                    <a href="#"><img src={postLandscape3} alt="" className="img-fluid" /></a>
                  ...
                  <div className="post-entry">
                    <a href="#"><img src={postLandscape6} alt="" className="img-fluid" /></a>
                    <div className="post-meta"><span className="date">Tech</span> <span className="mx-1">•</span> <span>Mar 1st '22</span></div>
                    <h2><a href="#">10 Life-Changing Hacks Every Working Mom Should Know</a></h2>
                  </div>
                  <div className="post-entry">
                    <a href="#"><img src={postLandscape8} alt="" className="img-fluid" /></a>
                    <div className="post-meta"><span className="date">Travel</span> <span className="mx-1">•</span> <span>Jul 5th '22</span></div>
